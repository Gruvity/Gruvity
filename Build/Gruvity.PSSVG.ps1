...
foreach ($variant in 'logo', 'animated-logo') {
    svg -content $(
        ...
        SVG.ArcPath -Start $circleTop -End $circleRight -Large -Radius $radius -Stroke 'transparent' -Id 'arc2' -Fill 'transparent'
        
        SVG.Circle -Cx (1080/2) -Cy (1080/2) -R ($radius*1.2) -Fill transparent -Stroke '#4488FF' -StrokeWidth 2% -Class 'foreground-stroke'
        SVG.Circle -Cx (1080/2) -Cy (1080/2) -R ($radius*0.3) -Fill transparent -Stroke '#4488FF' -StrokeWidth 2% -Class 'foreground-stroke'
    
        svg.text -X 86% -FontSize 10em @commonParameters -DominantBaseline 'middle' -Style "font-family:'$fontName'" -TextAnchor 'middle' @(        
        ...
        Join-Path $assetsPath "Gruvity-$($variant).svg"
    )    
}
